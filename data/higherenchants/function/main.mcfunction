...
execute as @e[nbt={DealtDamage:true,inGround:false,Air:300s,item:{id:"minecraft:trident",components:{"minecraft:enchantments":{"minecraft:channeling":2}}}},tag=!struck] run function higherenchants:trident_strike
# if a trident with channeling II strikes a lightning rod, execute trident strike
execute as @e[nbt={inBlockState:{Name:"minecraft:lightning_rod"},item:{id:"minecraft:trident",components:{"minecraft:enchantments":{"minecraft:channeling":2}}}},tag=!struck,limit=1] run function higherenchants:trident_strike